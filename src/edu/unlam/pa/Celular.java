	...
	public void resolver() {
		...
		if( memApp <= memTot) {
			for (int i = 0; i < vecApps.length; i++) {
				...
				if(sumaMem >= memApp) {
					if ( cantAppsAEliminar > j-i ) {
						cantAppsAEliminar = j-i;
						pos = i;
						memAnt = sumaMem;
					} else if( cantAppsAEliminar == j-i ) {
						if(memAnt < sumaMem){
							cantAppsAEliminar = j-i;
							pos = i;
							memAnt = sumaMem;
...
//	if(sumaMem >= memApp) {
//	if( j - i < cantAppsAEliminar) {
//		cantAppsAEliminar = j-i;
//		pos = i;
//		memAnt = sumaMem;
//	} else if (j-i == cantAppsAEliminar) {
//		if (memAnt < sumaMem)
//			cantAppsAEliminar = j-i;
//			pos = i;
//			memAnt = sumaMem;
...
//if ( j-i <= cantAppsAEliminar && sumaMem >= memApp)
//{
//     if( j - i < cantAppsAEliminar) {
//    	cantAppsAEliminar = j-i;
//		pos = i;
//		memAnt = sumaMem;
//     } else if (j-i == cantAppsAEliminar && memAnt < sumaMem) {
//    	cantAppsAEliminar = j-i;
//		pos = i;
//		memAnt = sumaMem;
//     }
